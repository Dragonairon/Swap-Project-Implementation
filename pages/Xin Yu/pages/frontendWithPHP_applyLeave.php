...
require_once __DIR__ . '/../../config/config.php'; // If "file not found" error, can remove it or comment it out because 'require_once __DIR__ . '/../../config/database.php';' is there to handle the db connection
